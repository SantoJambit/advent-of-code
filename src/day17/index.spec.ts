import { getCubeNeighbors3, getCubeNeighbors4, loadLayer, part1, part2, runCycle } from '.';
...
describe('runCycle', () => {
    describe('with 3 dimensions', () => {
        test('should return the active cubes after 1 cycle with the example input', () => {
            expect(runCycle(exampleInput3, getCubeNeighbors3).size).toBe(11);
        });
    ...
    describe('with 4 dimensions', () => {
        test('should return the active hypercubes after 1 cycle with the example input', () => {
            expect(runCycle(exampleInput4, getCubeNeighbors4).size).toBe(29);
        });
